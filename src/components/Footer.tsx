      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16">
          <div className="md:col-span-2">
            <h3 className="text-lg tracking-[0.3em] font-medium mb-6">SIVA REALTY</h3>
            <p className="text-muted-foreground text-sm leading-relaxed max-w-sm">
              Thoughtfully curated properties for discerning clients. 
              We believe in minimal design and maximum value.
            </p>
          </div>

          <div>
            <h4 className="text-sm font-medium mb-6 tracking-wide">Navigation</h4>
